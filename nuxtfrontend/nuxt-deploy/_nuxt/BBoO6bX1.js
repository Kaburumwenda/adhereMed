import{_ as B}from"./B2ybQ9nF.js";import{_ as N,u as U,O as F,k as G,f as H,m as p,w as t,cj as j,o as r,a as o,b as i,p as b,d as n,V as g,t as l,n as c,M as z,c as u,F as y,B as f,A as W,q as v}from"./D2-fh8bo.js";import{V as x}from"./CIlEh872.js";import{V as Q}from"./DoNhGRpK.js";import{V as h}from"./D_EQg4dz.js";import{a as C}from"./DQWRJPOt.js";import{V as K,a as w}from"./BjWq0mWx.js";import{V as $,a as T}from"./DFq8ps55.js";import{V as Y,a as Z}from"./iA3LoWXY.js";import{V as J}from"./CGTez616.js";import{V as X}from"./CLCNngmr.js";import"./DrOxqDuH.js";import"./DTP9bkLf.js";import"./DF_OU_lE.js";import"./BsoQQSHO.js";import"./B8J4I-iO.js";import"./zOqtiLjf.js";const ee={class:"docs-root"},te={class:"top-nav d-flex align-center px-4 px-md-12 py-3"},ie={class:"d-flex align-center mb-2 flex-wrap ga-2"},ae={class:"text-h4 text-md-h3 font-weight-bold mb-2"},oe={class:"text-h6 font-weight-light mb-4",style:{opacity:"0.92","max-width":"880px"}},ne={class:"d-flex align-center mb-3"},se={class:"text-h5 font-weight-bold section-title"},re={class:"text-caption section-tagline"},le=["innerHTML"],ce={key:0,class:"mt-3"},de=["innerHTML"],pe={__name:"docs",setup(ue){const A=new Date().toLocaleDateString(void 0,{year:"numeric",month:"short"});function R(){typeof window<"u"&&window.print()}const m=U(),M=F(),s=G(["pharmacy","homecare","lab"].includes(m.query.tab)?m.query.tab:"pharmacy");H(s,d=>{M.replace({query:{...m.query,tab:d}})});const E=v(()=>s.value==="homecare"?"AdhereMed Homecare Platform":s.value==="lab"?"AdhereMed Laboratory Platform":"AdhereMed Pharmacy Platform"),O=v(()=>s.value==="homecare"?"A comprehensive user guide covering every homecare module — from patient enrolment and care plans to medication doses, vitals, and teleconsult.":s.value==="lab"?"A comprehensive user guide covering every lab module — from requisitions and accessioning to results, QC, instruments, billing and the referring network.":"A comprehensive user guide covering every pharmacy module — from POS and inventory to deliveries, branches, purchase orders, and analytics."),k=v(()=>s.value==="homecare"?I:s.value==="lab"?q:V),V=[{id:"getting-started",title:"Getting Started",icon:"mdi-rocket-launch",color:"teal",tagline:"Sign in, navigate, and orient yourself.",body:`
      ...
      </ul>`}],I=[{id:"hc-getting-started",title:"Getting Started",icon:"mdi-rocket-launch",color:"teal",tagline:"Sign in, navigate the homecare workspace.",body:`
      ...
      <p>The Mail module connects an SMTP/IMAP mailbox to your homecare workspace, so referrals, reports, and family correspondence live alongside clinical records. Configure server settings under <i>Mail Settings</i>.</p>`},{id:"hc-insurance-billing",title:"Insurance & Billing",icon:"mdi-shield-account",color:"green-darken-2",tagline:"Coverage, claims, invoices.",body:`
      ...
      </ul>`}],q=[{id:"lab-getting-started",title:"Getting Started",icon:"mdi-rocket-launch",body:`
      ...
      <p>Recommended first-time setup: create your test catalog &rarr; build panels &rarr; register instruments &rarr; add referring doctors and facilities &rarr; design a default report template.</p>`},{id:"lab-test-catalog",title:"Test Catalog",icon:"mdi-flask-outline",body:`
      ...
      </ul>`},{id:"lab-panels",title:"Panels",icon:"mdi-package-variant",body:`
      ...
      </ul>`},{id:"lab-requisitions",title:"Requisitions",icon:"mdi-clipboard-text-clock",body:`
      ...
      </ul>`},{id:"lab-accessioning",title:"Accessioning &amp; Specimens",icon:"mdi-barcode-scan",body:`
      ...
      </ul>`},{id:"lab-worklist",title:"Worklists",icon:"mdi-test-tube",body:`
      <p>The worklist is the technologist's view of work in progress, grouped by status (Pending, Collected, Processing, Completed). Each row jumps directly to the result entry screen.</p>`},{id:"lab-results",title:"Results &amp; Verification",icon:"mdi-file-chart",body:`
      ...
      </ul>`},{id:"lab-qc",title:"Quality Control",icon:"mdi-chart-bell-curve-cumulative",body:`
      ...
      <p>QC failures should block release of patient results on that instrument until corrective action is documented.</p>`},{id:"lab-instruments",title:"Instruments &amp; Maintenance",icon:"mdi-cog-transfer",body:`
      <p>Track every analyzer with its model, manufacturer, serial number and department. Use the status field to mark <b>Active</b>, <b>Maintenance</b>, <b>Offline</b> or <b>Retired</b>. Record the last and next service dates to plan preventive maintenance.</p>`},{id:"lab-referring",title:"Referring Network",icon:"mdi-stethoscope",body:`
      <p>Maintain external clinicians and the facilities they belong to. Each doctor can have a commission percent; each facility can have a contracted discount percent that flows into invoicing.</p>`},{id:"lab-billing",title:"Billing &amp; Invoicing",icon:"mdi-receipt-text",body:`
      ...
      </ul>`},{id:"lab-home-visits",title:"Home Sample Visits",icon:"mdi-home-import-outline",body:`
      <p>Schedule lab tech visits to a patient's address for sample collection. Track the assigned tech, scheduled date/time, status and completion timestamp. Use this for chronic-care monitoring and home-based collections.</p>`},{id:"lab-templates",title:"Report Templates",icon:"mdi-printer-pos",body:`
      <p>Design the look of printed reports. Each template has header HTML (logo, lab name, accreditation), footer HTML (disclaimers, contact), and a signatory (name, title, optional signature image). Mark one as <b>Default</b> for use on all reports.</p>`},{id:"lab-analytics",title:"Reports &amp; Analytics",icon:"mdi-chart-box",body:`
      <p>The dashboard surfaces same-day KPIs. Use the global Reports module for revenue trends, test mix by department, turnaround-time distributions, rejection rates, and referring-source contribution.</p>`},{id:"lab-roles",title:"Roles &amp; Permissions",icon:"mdi-shield-account",body:`
      <ul>
      ...
      </ul>`},{id:"lab-troubleshooting",title:"Troubleshooting",icon:"mdi-lifebuoy",body:`
      <ul>
      ...
      </ul>`}];return(d,e)=>{const D=B,L=j;return r(),p(L,{name:"auth"},{default:t(()=>[o("div",ee,[e[15]||(e[15]=o("div",{class:"brand-gradient bg-fill"},null,-1)),e[16]||(e[16]=o("div",{class:"blob blob-1"},null,-1)),e[17]||(e[17]=o("div",{class:"blob blob-2"},null,-1)),o("div",te,[i(b,{variant:"text",class:"text-none","prepend-icon":"mdi-arrow-left",style:{color:"#fff !important"},onClick:e[0]||(e[0]=a=>d.$router.push("/welcome"))},{default:t(()=>[...e[4]||(e[4]=[n(" Back ",-1)])]),_:1}),i(x),i(D,{size:16,"bold-color":"white","light-color":"white"}),i(x),i(b,{variant:"outlined",class:"text-none mr-2",rounded:"lg",style:{color:"#fff !important","border-color":"rgba(255,255,255,0.7)"},onClick:e[1]||(e[1]=a=>d.$router.push("/login"))},{default:t(()=>[...e[5]||(e[5]=[n(" Sign In ",-1)])]),_:1}),i(b,{color:"white",class:"text-none",rounded:"lg",style:{color:"#0F766E"},onClick:e[2]||(e[2]=a=>R())},{default:t(()=>[i(g,{class:"mr-1"},{default:t(()=>[...e[6]||(e[6]=[n("mdi-printer",-1)])]),_:1}),e[7]||(e[7]=n(" Print ",-1))]),_:1})]),i(Q,{class:"docs-container py-8 py-md-10",style:{position:"relative","z-index":"2","max-width":"1280px"}},{default:t(()=>[i(h,{flat:"",rounded:"xl",class:"docs-hero pa-6 pa-md-10 mb-6 text-white"},{default:t(()=>[o("div",ie,[i(C,{color:"white",variant:"flat",size:"small",style:{color:"#0F766E","font-weight":"700"}},{default:t(()=>[i(g,{size:"14",start:""},{default:t(()=>[...e[8]||(e[8]=[n("mdi-book-open-variant",-1)])]),_:1}),e[9]||(e[9]=n(" User Guide ",-1))]),_:1}),i(C,{color:"white",variant:"outlined",size:"small"},{default:t(()=>[n("v1.0 · "+l(c(A)),1)]),_:1})]),o("div",ae,l(c(E)),1),o("div",oe,l(c(O)),1),i(K,{modelValue:c(s),"onUpdate:modelValue":e[3]||(e[3]=a=>z(s)?s.value=a:null),"bg-color":"transparent",color:"white","slider-color":"white",density:"comfortable",class:"docs-tabs"},{default:t(()=>[i(w,{value:"pharmacy",class:"text-none","prepend-icon":"mdi-pill"},{default:t(()=>[...e[10]||(e[10]=[n("Pharmacy",-1)])]),_:1}),i(w,{value:"homecare",class:"text-none","prepend-icon":"mdi-home-heart"},{default:t(()=>[...e[11]||(e[11]=[n("Homecare",-1)])]),_:1}),i(w,{value:"lab",class:"text-none","prepend-icon":"mdi-microscope"},{default:t(()=>[...e[12]||(e[12]=[n("Laboratory",-1)])]),_:1})]),_:1},8,["modelValue"])]),_:1}),i($,{dense:""},{default:t(()=>[i(T,{cols:"12",md:"3"},{default:t(()=>[i(h,{flat:"",rounded:"lg",class:"docs-toc pa-3 sticky-toc"},{default:t(()=>[e[13]||(e[13]=o("div",{class:"toc-overline mb-1"},"Contents",-1)),i(Y,{density:"compact",nav:"",class:"bg-transparent toc-list"},{default:t(()=>[(r(!0),u(y,null,f(c(k),a=>(r(),p(Z,{key:a.id,href:`#${a.id}`,title:a.title,"prepend-icon":a.icon,rounded:"lg"},null,8,["href","title","prepend-icon"]))),128))]),_:1})]),_:1})]),_:1}),i(T,{cols:"12",md:"9"},{default:t(()=>[(r(!0),u(y,null,f(c(k),a=>(r(),p(h,{key:a.id,id:a.id,flat:"",rounded:"lg",class:"docs-section pa-5 pa-md-7 mb-4"},{default:t(()=>{var P;return[o("div",ne,[i(J,{color:a.color||"primary",variant:"tonal",size:"40",class:"mr-3"},{default:t(()=>[i(g,{color:a.color||"primary"},{default:t(()=>[n(l(a.icon),1)]),_:2},1032,["color"])]),_:2},1032,["color"]),o("div",null,[o("div",se,l(a.title),1),o("div",re,l(a.tagline),1)])]),o("div",{innerHTML:a.body,class:"docs-body"},null,8,le),(P=a.tips)!=null&&P.length?(r(),u("div",ce,[(r(!0),u(y,null,f(a.tips,(S,_)=>(r(),p(X,{key:_,type:S.type||"info",variant:"tonal",density:"compact",class:"mb-2"},{default:t(()=>[o("div",{innerHTML:S.text},null,8,de)]),_:2},1032,["type"]))),128))])):W("",!0)]}),_:2},1032,["id"]))),128)),i(h,{flat:"",rounded:"lg",class:"pa-5 text-center docs-section"},{default:t(()=>[...e[14]||(e[14]=[o("div",{class:"text-body-2 text-medium-emphasis"},[n(" Need more help? Reach support at "),o("a",{href:"mailto:support@adheremed.com"},"support@adheremed.com"),n(". ")],-1)])]),_:1})]),_:1})]),_:1})]),_:1})])]),_:1})}}},Oe=N(pe,[["__scopeId","data-v-8f154404"]]);export{Oe as default};
