import{_ as B}from"./Be1HvFxK.js";import{_ as N,u as U,M as F,k as G,f as H,m as p,w as t,cd as j,o as r,a as o,b as i,p as b,d as n,V as g,t as l,n as c,K as z,c as u,F as y,A as f,B as W,q as v}from"./D5A-w74S.js";import{V as x}from"./CEjUx_aB.js";import{V as Q}from"./zrFh0cOf.js";import{V as m}from"./Co3rSNa7.js";import{a as C}from"./hXgTnQ-t.js";import{V as K,a as w}from"./jaMJrTyR.js";import{V as $,a as T}from"./B5dM5f1C.js";import{V as Y,a as Z}from"./DkIeH74i.js";import{V as J}from"./CqVPDO5m.js";import{V as X}from"./2B2bVsGj.js";import"./BjWPZgOT.js";import"./C5PHKuFm.js";import"./D-C9mOey.js";import"./BXQZ1APp.js";const ee={class:"docs-root"},te={class:"top-nav d-flex align-center px-4 px-md-12 py-3"},ie={class:"d-flex align-center mb-2 flex-wrap ga-2"},ae={class:"text-h4 text-md-h3 font-weight-bold mb-2"},oe={class:"text-h6 font-weight-light mb-4",style:{opacity:"0.92","max-width":"880px"}},ne={class:"d-flex align-center mb-3"},se={class:"text-h5 font-weight-bold section-title"},re={class:"text-caption section-tagline"},le=["innerHTML"],ce={key:0,class:"mt-3"},de=["innerHTML"],pe={__name:"docs",setup(ue){const A=new Date().toLocaleDateString(void 0,{year:"numeric",month:"short"});function R(){typeof window<"u"&&window.print()}const h=U(),M=F(),s=G(["pharmacy","homecare","lab"].includes(h.query.tab)?h.query.tab:"pharmacy");H(s,d=>{M.replace({query:{...h.query,tab:d}})});const E=v(()=>s.value==="homecare"?"AdhereMed Homecare Platform":s.value==="lab"?"AdhereMed Laboratory Platform":"AdhereMed Pharmacy Platform"),O=v(()=>s.value==="homecare"?"A comprehensive user guide covering every homecare module — from patient enrolment and care plans to medication doses, vitals, teleconsult, and family portal.":s.value==="lab"?"A comprehensive user guide covering every lab module — from requisitions and accessioning to results, QC, instruments, billing and the referring network.":"A comprehensive user guide covering every pharmacy module — from POS and inventory to deliveries, branches, purchase orders, and analytics."),k=v(()=>s.value==="homecare"?I:s.value==="lab"?q:V),V=[{id:"getting-started",title:"Getting Started",icon:"mdi-rocket-launch",color:"teal",tagline:"Sign in, navigate, and orient yourself.",body:`
