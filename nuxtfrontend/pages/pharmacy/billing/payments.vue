<template>
  <v-container fluid class="pa-4 pa-md-6">
    ...
    >
      <template #actions>
        <v-btn variant="text" prepend-icon="mdi-chart-box" to="/pharmacy/billing/usage">Usage & Bills</v-btn>
        <v-btn color="primary" variant="flat" prepend-icon="mdi-wallet-plus" @click="openAddFunds">Add funds</v-btn>
          ...
          <v-tabs-window-item value="outstanding">
            ...
            >
              ...
              <template #item.actions="{ item }">
                <v-btn size="small" variant="text" :to="`/pharmacy/billing/bills/${item.id}`">View</v-btn>
                <v-btn
                  size="small"
                  color="primary"
                  variant="flat"
