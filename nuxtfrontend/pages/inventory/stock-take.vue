    ...
    <div class="d-flex flex-wrap align-center justify-space-between mb-4">
      <div class="d-flex align-center">
        <v-avatar color="indigo-lighten-5" size="48" class="mr-3">
          <v-icon color="indigo-darken-2" size="28">mdi-clipboard-list-outline</v-icon>
        </v-avatar>
        <div>
          <h1 class="text-h5 font-weight-bold mb-1">{{ $t('stockTake.title') }}</h1>
          <div class="text-body-2 text-medium-emphasis">Cycle counts, variance reports &amp; auto-reconciliation</div>
        </div>
      </div>
      <div class="d-flex align-center mt-2 mt-md-0" style="gap:8px">
        <v-btn rounded="lg" color="primary" variant="flat" class="text-none"
                 prepend-icon="mdi-plus" @click="openCreate">{{ $t('stockTake.newCount') }}</v-btn>
      ...
      <v-card v-if="active" tile class="d-flex flex-column" style="height:100vh">
        ...
        <v-row no-gutters class="flex-grow-1">
          ...
          <v-col cols="12" md="3" class="pa-4 bg-grey-lighten-4 d-none d-md-block" style="overflow:auto">
            ...
            <v-card flat class="pa-3 mb-2" border>
              <div class="text-caption text-medium-emphasis">{{ $t('stockTake.counted') }}</div>
            ...
            <v-card flat class="pa-3 mb-2" border>
              <div class="text-caption text-medium-emphasis">{{ $t('stockTake.totalVariance') }}</div>
